...
const WeddingService = (): JSX.Element => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0b0b0f] text-white overflow-hidden pt-28">
      ...
      <SectionHeader
        ...
        highlight="Cake Collection"
        description="Beautifully designed wedding cakes crafted to match your dream celebration with style, taste, and elegance."
        light
        className="mb-12"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-14">
        ...
        <ScrollAnimation x={80} y={60} duration={0.8}>
        <div>
          <h2 className="text-2xl font-bold mb-6">Wedding Cake Price List</h2>

          <div className="space-y-5">
            {[
              {
                title: "2-Tier Wedding Cake",
                price: "GH₵ 1200",
                desc: "Elegant, delicious, and handcrafted for your special day.",
              },
              {
                title: "3-Tier Wedding Cake",
                price: "GH₵ 2000",
                desc: "Perfect for medium weddings with elegant design layers.",
              },
              {
                title: "Luxury Wedding Cake",
                price: "From GH₵ 3,500",
                desc: "Grand multi-tier masterpiece for luxury celebrations.",
              },
              {
                title: "Floral Design Upgrade",
                price: "GH₵ 400",
                desc: "Enhance your cake with premium floral decorations.",
              },
            ].map((item, i) => (
              <div
                key={i}
